...
public class ArrayBasedQueue<E> extends AbstractQueue<E> {
     ...
     * @param element This is the element to add to the queue.
     */
	@Override
	...
	/**
	 * This removes an element to the queue.
	 * @return result: This is the removed element.
	 * @throws java.util.NoSuchElementException This throws an exception if the queue is empty.
	 */
	@Override
	...
	/**
	 * This returns the first element in the queue.
	 * @return front: This is the first element in the queue.
	 * @throws java.util.NoSuchElementException This throws an exception if the queue is empty.
	 */
	@Override
	 ...
	 * @return size: This is the size of the queue.
	 */
	@Override
	public int size() {
		return size;
