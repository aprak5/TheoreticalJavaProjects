...
public abstract class AbstractPriorityQueue<K extends Comparable<K>, V> implements PriorityQueue<K, V> {
    ...
    /**
     * This sets the comparator for this queue.
     * @param c The comparator to set to.
     */
     ...
     * @return Whether the queue is of size 0 or not.
     */
    @Override
    ...
    public static class PQEntry<K, V> implements Entry<K, V> {
        ...
        /**
         * This returns the key for the entry.
         * @return key: The key for the entry.
         */
        @Override
        public K getKey() {
            return key;
        ...
        /**
         * This returns the value for the entry.
         * @return value: The value for the entry.
         */
        @Override
        public V getValue() {
            return value;
     ...
     * @return The entry created with the provided key and value.
     */
