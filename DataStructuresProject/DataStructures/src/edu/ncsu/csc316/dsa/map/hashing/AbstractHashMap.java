...
public abstract class AbstractHashMap<K, V> extends AbstractMap<K, V> {
    ...
    /**
     * This puts a given entry with a given key and value into the map.
     * @param key The key of the given entry to put.
     * @param value The value of the given entry to put.
     * @return The value of the entry added.
     */
    @Override
    ...
    /**
     * This gets a given entry with a given key from the map.
     * @param key The key of the given entry to get.
     * @return The value of the entry to get.
     */
    @Override
    public V get(K key) {
     ...
     * @param key The key of the given entry to remove.
