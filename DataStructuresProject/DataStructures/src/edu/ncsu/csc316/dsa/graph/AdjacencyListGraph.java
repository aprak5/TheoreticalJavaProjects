...
public class AdjacencyListGraph<V, E> extends AbstractGraph<V, E> {
    ...
    public Edge<E> insertEdge(Vertex<V> v1, Vertex<V> v2, E edgeData) {
        ...
        Position<Edge<E>> pos2 = origin.getOutgoing().addLast(edge);
        edge.setOutgoingListPosition(pos2);
        Position<Edge<E>> pos3 = destination.getIncoming().addLast(edge);
        edge.setIncomingListPosition(pos3);
        return edge;
    }
    ...
    public void removeVertex(Vertex<V> vertex) {
        ...
        for(Edge<E> e : v.getIncoming()) {
        	...
        	v.getIncoming().remove(validate(e).getIncomingListPosition());
        	v.getOutgoing().remove(validate(e).getOutgoingListPosition());
        }
     ...
     * 
     * @param e The edge to validate for the graph.
