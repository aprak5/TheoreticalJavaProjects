...
public abstract class AbstractGraph<V, E> implements Graph<V, E> {
    ...
    /**
     * Sets the isDirected field to the given value.
    ...
    /**
     * The gives the endpoints (vertices) for a given edge.
     * @param edge The edge to give the endpoints for.
     * @return The list of end vertices for the edge.
     */
    @Override
    ...
    /**
     * The vertex opposite of a given vertex and edge.
     * @param vertex The vertex for the opposite vertex.
     * @param edge The edge for the opposite vertex.
     * @return The opposite vertex for the given vertex and edge.
     * @throws java.lang.IllegalArgumentException If the given vertex is not incident for the given edge, an IAE is thrown.
     */
    @Override
    ...
    protected class GraphVertex implements Vertex<V> {
        ...
        private V element;
        /**The position for the GraphVertex*/
        ...
        /**
         * Gets the element for the GraphVertex.
         * @return The element for the GraphVertex.
         */
        @Override
        public V getElement() {
            return element;
    ...
    protected class GraphEdge implements Edge<E> {
        ...
        private E element;
        /**The endpoints for the GraphEdge*/
        ...
        /**
         * Gets the element for the GraphEdge.
         * @return The element for the GraphEdge.
         */
        @Override
        public E getElement() {
            return element;
        ...
        /**
         * Gives a string representation of an edge.
     ...
     * @throws IllegalArgumentException If the Edge is not a valid GraphEdge, is an IAE.
     */
    protected GraphEdge validate(Edge<E> e) throws IllegalArgumentException {
