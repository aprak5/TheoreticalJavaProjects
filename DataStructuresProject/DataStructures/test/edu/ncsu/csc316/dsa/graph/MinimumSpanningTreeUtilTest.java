...
public class MinimumSpanningTreeUtilTest {
	...
	public void testKruskal() {
        ...
        PositionalList<Edge<Highway>> outputUndirected = MinimumSpanningTreeUtil.kruskal(undirectedGraph);
        PositionalList<Edge<Highway>> outputDirected = MinimumSpanningTreeUtil.kruskal(directedGraph);
	...
	public void testPrimJarnik() {
        ...
        PositionalList<Edge<Highway>> outputUndirected = MinimumSpanningTreeUtil.primJarnik(undirectedGraph);
        PositionalList<Edge<Highway>> outputDirected = MinimumSpanningTreeUtil.primJarnik(directedGraph);
		assertNotNull(outputUndirected);
		assertNotNull(outputDirected);
	}
}
