...
/**
 * Tests the class {@link BubbleSorter}.
 * @author Amit Prakash
 */
public class BubbleSorterTest {
	...
	/**The test bubble sorter object for strings.*/
	private BubbleSorter<String> stringSorter;
	/**The test bubble sorter object for students.*/
	private BubbleSorter<Student> studentSorter = new BubbleSorter<Student>(new StudentGPAComparator());
	/**
	 * This initializes the string sorter for the string sorting.
	 */
	@Before
	public void setUp() {
		stringSorter = new BubbleSorter<String>();
	}
	/**
