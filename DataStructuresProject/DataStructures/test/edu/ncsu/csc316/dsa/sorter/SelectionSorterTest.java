...
/**
 * Tests the class {@link SelectionSorter}.
 * @author Amit Prakash
 */
public class SelectionSorterTest {
	...
	/**The test selection sorter object for strings.*/
	private SelectionSorter<Student> studentSorter = new SelectionSorter<Student>(new StudentGPAComparator());
	/**The test selection sorter object for students.*/
	private SelectionSorter<String> stringSorter;
	/**
	 * This initializes the string sorter for the string sorting.
	 */
	@Before
	public void setUp() {
		stringSorter = new SelectionSorter<String>();
	}
	/**
