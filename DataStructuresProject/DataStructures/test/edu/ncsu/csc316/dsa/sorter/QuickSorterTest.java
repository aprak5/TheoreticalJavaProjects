...
public class QuickSorterTest {
	...
	public void setUp() {
		...
		sorter = new QuickSorter<Student>(QuickSorter.FIRST_ELEMENT_SELECTOR);
		assertNotNull(sorter);
	...
	public void testSortStudent() {
		...
		sorter = new QuickSorter<Student>(new StudentIDComparator(), QuickSorter.FIRST_ELEMENT_SELECTOR);
		sorter.sort(original);
		assertEquals(sOne, original[0]);
		assertEquals(sTwo, original[1]);
		assertEquals(sThree, original[2]);
		...
		sorter = new QuickSorter<Student>(new StudentIDComparator(), QuickSorter.LAST_ELEMENT_SELECTOR);
		sorter.sort(original);
		...
		sorter = new QuickSorter<Student>(new StudentIDComparator(), QuickSorter.MIDDLE_ELEMENT_SELECTOR);
		sorter.sort(original);
