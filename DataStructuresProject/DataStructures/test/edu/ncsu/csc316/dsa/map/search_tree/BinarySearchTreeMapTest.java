...
public class BinarySearchTreeMapTest {
    ...
    public void testPut() {
        ...
        tree.put(5, "five");
        assertEquals(5, (int)tree.right(tree.right(tree.right(tree.right(tree.root())))).getElement().getKey());
        tree.put(6, "six");
        assertEquals(6, (int)tree.right(tree.right(tree.right(tree.right(tree.right(tree.root()))))).getElement().getKey());
